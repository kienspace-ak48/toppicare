...
const newsArticles00 = [
  {
    ...
    category: "Tin tức",
    excerpt:
      "Chúng tôi vui mừng thông báo về sự ra mắt chi nhánh mới tại Hà Nội, mang đến dịch vụ chăm sóc sức khỏe chất lượng cao cho khách hàng miền Bắc...",
  ...
  },
  {
    ...
    category: "Khuyến mãi",
    excerpt:
      "Giảm giá lên đến 30% cho các gói dịch vụ spa cao cấp. Áp dụng từ 20/12 đến 31/12/2024...",
  ...
  },
  {
    ...
    category: "Sức khỏe",
    excerpt:
      "Khám phá những lợi ích tuyệt vời mà massage mang lại cho cơ thể và tinh thần, từ giảm stress đến cải thiện tuần hoàn máu...",
  ...
  },
  {
    ...
    category: "Hoạt động",
    excerpt:
      "Chúng tôi tự hào tham gia chương trình khám và massage miễn phí cho người cao tuổi tại các viện dưỡng lão...",
  ...
  },
  {
    ...
    category: "Mẹo hay",
    excerpt:
      "Các bài tập đơn giản giúp giảm đau vai gáy ngay tại văn phòng, không cần thiết bị hỗ trợ...",
  ...
  },
  {
    ...
    category: "Tin tức",
    excerpt:
      "Sự ghi nhận của thị trường và khách hàng là động lực để chúng tôi không ngừng phát triển và nâng cao chất lượng dịch vụ...",
    image: "https://images.unsplash.com/photo-1764690690771-b4522d66b433?w=600",
    date: "01/12/2024",
    featured: false,
  },
  {
    ...
    category: "Mẹo hay",
    excerpt:
      "Hướng dẫn lựa chọn loại tinh dầu phù hợp với từng loại da và mục đích sử dụng để đạt hiệu quả tối ưu...",
    image: "https://images.unsplash.com/photo-1757689314932-bec6e9c39e51?w=600",
    date: "28/11/2024",
    featured: false,
  },
  {
    ...
    category: "Khuyến mãi",
    excerpt:
      "Giới thiệu bạn bè sử dụng dịch vụ và nhận ngay voucher trị giá 1 triệu đồng. Số lượng có hạn...",
    image: "https://images.unsplash.com/photo-1745327883508-b6cd32e5dde5?w=600",
    date: "25/11/2024",
    featured: false,
  },
  {
    ...
    category: "Sức khỏe",
    excerpt:
      "Dịch vụ massage chuyên biệt dành cho phụ nữ mang thai, giúp giảm đau lưng và căng thẳng an toàn...",
    image: "https://images.unsplash.com/photo-1759216852567-5e1dd25f79f6?w=600",
    date: "20/11/2024",
    featured: false,
  },
      ...
      {/* <section className="py-16 bg-[#2dbdb6]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg mb-8 text-[16px]">
            Nhận thông tin mới nhất về dịch vụ, khuyến mãi và mẹo chăm sóc sức
            khỏe
          </p>
